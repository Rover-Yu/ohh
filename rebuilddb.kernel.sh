...
find drivers/ -name "*.[chS]" | grep -E -e '(/acpi/)|(/base/)|(/block/)|(ers/char/)|(clocksource/)|(dma/)|(/net/igb/)|(/pci/)|(net/loopback.c)' >> cscope.files
...
find net/ -name "*.[chS]" | grep -E -e "(^net/core)|(^net/sched)|(^net/ethernet)|(^net/ipv4)|(^net/unix)|(^net/netfilter)|(^net/netlink)" >> cscope.files 
